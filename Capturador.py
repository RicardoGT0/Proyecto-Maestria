...
def extraccion_secuencia():
    ...
    if ((10 * 0.7) < n_actual.getCuenta()) and (not (n_actual in secuencia)):
...
def extraccion_tarea():
    ...
    i = l_secuencias.index(secuencia) -1
    l_conteo[i] += 1
...
# inicio de los Hilos
proc.start() #Procesamiento y creacion del arbol
resp.start() #Respaldo de informacion
...
gif = AnimatedGIF(master, "Alegre.gif")
gif.pack()
